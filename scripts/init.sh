...
sudo apt-get -qqy install apache2 php7.3 libapache2-mod-php php7.3-mysql php7.3-gettext curl php7.3-cli php7.3-gd php7.3-mbstring php7.3-xml php7.3-curl php7.3-bz2 php7.3-zip git unzip php7.3-xdebug -y
